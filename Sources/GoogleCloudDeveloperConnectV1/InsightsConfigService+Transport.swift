  ...
  final class InsightsConfigServiceTransport: InsightsConfigServiceStub {
    ...
    public func listInsightsConfigs(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/insightsConfigs"
      }()
      var query = [
    ...
    public func updateInsightsConfig(
      ...
      let path = try { () throws -> Swift.String in
        guard let pathVariable0 = request.insightsConfig.map({ $0.name }), !pathVariable0.isEmpty
        else {
          throw GoogleCloudGax.RequestError.binding(
            "'request.insights_config.name' is not set or is empty")
        }
        return "/v1/\(pathVariable0)"
      }()
      var query = [
    ...
    public func listDeploymentEvents(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/deploymentEvents"
      }()
      var query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
